    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -150, left: -100,
            child: _GlowBlob(color: context.colors.accentViolet.withOpacity(0.3), size: 400),
          ).animate(onPlay: (controller) => controller.repeat(reverse: true)).moveY(end: 50, duration: 4.seconds),
          Positioned(
            bottom: -150, right: -100,
            child: _GlowBlob(color: context.colors.accent.withOpacity(0.2), size: 500),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [context.colors.primaryEnd, context.colors.primaryStart],
                          ...
                          Text('Sign up to start creating',
                              ...
                              child: Ink(
                                ...
                                child: Container(
                                  ...
                                  child: _isLoading 
                                      ...
                                      : Text('Sign Up', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
                                ),
                              ),
                            ),
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              Text("Already have an account? ", style: GoogleFonts.inter(color: context.colors.textSecondary)),
                              GestureDetector(
                                onTap: () => Navigator.of(context).pushReplacement(
                                    MaterialPageRoute(builder: (_) => const LoginScreen())),
                                child: Text('Login', style: GoogleFonts.inter(color: context.colors.primary, fontWeight: FontWeight.bold)),
                              ),
                            ],
                          ),
                        ],
